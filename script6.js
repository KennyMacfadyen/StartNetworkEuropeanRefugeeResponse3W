...
var agencyChart = dc.rowChart('#Agency');

var xf = crossfilter (data);

var countryDimension = xf.dimension(function (d) {
    return d.Country;
});
var provinceDimension = xf.province(function (d) {
    return d.Province;
});
var agencyDimension = xf.agency(function (d) {
    return d.Agency;
});
var sectorDimension = xf.sector(function (d) {
    return d.Sector;
});
